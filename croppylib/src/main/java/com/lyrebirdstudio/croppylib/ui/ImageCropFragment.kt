...
import com.lyrebirdstudio.croppylib.util.extensions.invisible

class ImageCropFragment : Fragment() {

    private val binding: FragmentImageCropBinding by inflate(R.layout.fragment_image_crop)

    private lateinit var viewModel: com.lyrebirdstudio.croppylib.ui.ImageCropViewModel

    var onApplyClicked: ((com.lyrebirdstudio.croppylib.ui.CroppedBitmapData) -> Unit)? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewModel = ViewModelProviders.of(this).get(com.lyrebirdstudio.croppylib.ui.ImageCropViewModel::class.java)

        val cropRequest = arguments?.getParcelable(com.lyrebirdstudio.croppylib.ui.ImageCropFragment.Companion.KEY_BUNDLE_CROP_REQUEST) ?: CropRequest.empty()
...
//        }
    ...
    companion object {
        ...
        @JvmStatic
        fun newInstance(cropRequest: CropRequest): com.lyrebirdstudio.croppylib.ui.ImageCropFragment {
            return com.lyrebirdstudio.croppylib.ui.ImageCropFragment().apply {
                arguments = Bundle().apply {
                    putParcelable(com.lyrebirdstudio.croppylib.ui.ImageCropFragment.Companion.KEY_BUNDLE_CROP_REQUEST, cropRequest)
                }
            }
        }
    }
