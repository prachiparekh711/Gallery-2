...
class CroppyActivityViewModel(val app: Application) : AndroidViewModel(app) {
    ...
    fun saveBitmap(cropRequest: com.lyrebirdstudio.croppylib.main.CropRequest, croppedBitmapData: CroppedBitmapData) {

        when (cropRequest) {
            is com.lyrebirdstudio.croppylib.main.CropRequest.Manual -> {
                disposable.add(
                    BitmapUtils
            ...
            is com.lyrebirdstudio.croppylib.main.CropRequest.Auto -> {
