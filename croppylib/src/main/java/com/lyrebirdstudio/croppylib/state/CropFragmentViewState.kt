...
data class CropFragmentViewState(
    ...
    fun onAspectRatioChanged(aspectRatio: AspectRatio): com.lyrebirdstudio.croppylib.state.CropFragmentViewState {
        return com.lyrebirdstudio.croppylib.state.CropFragmentViewState(
    ...
    fun onCropSizeChanged(cropRect: RectF): com.lyrebirdstudio.croppylib.state.CropFragmentViewState {
        return com.lyrebirdstudio.croppylib.state.CropFragmentViewState(
                sizeInputData = SizeInputData(
    ...
    fun onThemeChanged(croppyTheme: CroppyTheme): com.lyrebirdstudio.croppylib.state.CropFragmentViewState {
        return com.lyrebirdstudio.croppylib.state.CropFragmentViewState(
                sizeInputData = sizeInputData,
                aspectRatio = aspectRatio,
                croppyTheme = croppyTheme
