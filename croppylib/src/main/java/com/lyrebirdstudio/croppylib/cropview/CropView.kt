...
class CropView @JvmOverloads constructor(
     ...
     */
    private var aspectAspectMode: com.lyrebirdstudio.croppylib.cropview.AspectMode = FREE
    ...
    private val bitmapGestureListener = object : com.lyrebirdstudio.croppylib.cropview.BitmapGestureHandler.BitmapGestureListener {
        override fun onDoubleTap(motionEvent: MotionEvent) {

            if (isBitmapScaleExceedMaxLimit(com.lyrebirdstudio.croppylib.cropview.CropView.Companion.DOUBLE_TAP_SCALE_FACTOR)) {
            ...
            bitmapMatrix.animateScaleToPoint(
                    com.lyrebirdstudio.croppylib.cropview.CropView.Companion.DOUBLE_TAP_SCALE_FACTOR,
                motionEvent.x,
                motionEvent.y
            ) {
                notifyCropRectChanged()
    ...
    private val bitmapGestureHandler = com.lyrebirdstudio.croppylib.cropview.BitmapGestureHandler(context, bitmapGestureListener)
    ...
    fun setBitmap(bitmap: Bitmap?) {
        ...
        val bitmapMinRectSize = max(bitmapRect.width(), bitmapRect.height()) / com.lyrebirdstudio.croppylib.cropview.CropView.Companion.MAX_SCALE
